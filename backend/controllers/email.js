  ...
  if (!email && phone) {
    ...
    transport
      .sendMail({
        ...
        to: email,
        subject: `ABCPerfume Ecommerce - ${title}`,
        html: `<div>
                    <h2>ABC Perfume!</h2>
                    <h1>${title}</h1>
                    <p>Hi ${name},</p>
                    <p>Thank you for choosing ABC Perfume.</p>
                    <p>${text}</p>
                    ${
                      code
                        ? `<button style="background-color:#3e97a9; border:none; border-radius:4px; padding:0;">
                            <a 
